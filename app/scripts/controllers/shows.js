...
angular.module('liteWaveApp').controller('ShowsController',
  ...
  function ($rootScope, $scope, $timeout, $routeParams, Clients, Stadiums, LogicalLayout, Shows2)
  {
    ...
    $scope.testLayout = function ()
    {
      ...
      {
        //$scope.stadiumMap.tuMap("HighlightSection", $scope.currentSections[i]);

        /*$scope.toggleSections($scope.myData[cmdsIndex].sectionList);
        console.log("==============================================================");
        console.log("0: cmdsIndex = " + cmdsIndex + ". $scope.myData[cmdsIndex].sectionList=" + $scope.myData[cmdsIndex].sectionList);
        console.log("==============================================================");*/
